...
const mostBlogs = (blogs) => {
  ...
  const most = Object.entries(authors).reduce((most_active, author) =>
    most_active[1] < author[1] ? author : most_active,
  );
...
const mostLikes = (blogs) => {
  ...
  const most = Object.entries(authors).reduce((most_liked, author) =>
    most_liked[1] < author[1] ? author : most_liked,
  );
